...
* **[Contactless Files Port]()**\
**Система чтения и записи файлов на бесконтактные смарт-карты**\
  2023-2024
  > ![Uploading image.png…]()
  > ОС: Windows, Linux\
  > Стек: Arduino C, Python\
  > Описание проекта:
  > *ТУТ БУДЕТ ОПИСАНИЕ*


* **[Система контроля опазданий сотрудников]**\
  2023-2024
  > Тут будет добавлен скриншот и размещена информация

* **[Модель карданного подвеса](https://github.com/raduma142/gimbal-model)**\
  2022-2023
  > ![Снимок экрана 2023-09-16 143704](https://github.com/raduma142/raduma142/assets/69161202/58fe1ec2-8eee-481a-8e75-5d30544e1020)\
  > ОС: Windows\
  > Стек: C# WPF (паттерн MVVM), Unity Engine\
  > Описание проекта:\
  > *Проект представляет собой комплекс программ для управления, расчёта, сбора и хранения данных, а также визуализации модели карданного подвеса с целью вычисления мощностей физических управляющих воздействий на рамки подвеса с учётом недопущения складывания рамок путём вычислений углов 4-х рамок таким образом, чтобы углы между ними не были менее 45-ти градусов.\
  > Проект выполнен в рабочей обстановке и позволил получить навыки работы с Unity Engine, сокетами, а также математическими и физическими вычислениями углов, векторов, кватернионов и мощностей.\
  > **Код проекта и программа закрыты.***
...
* **[Система управления регистраторами данных](https://github.com/raduma142/data-logger-management-system)**\
  ...
  > **Код проекта и программа закрыты.**\
  > [Подробное описание проекта](https://github.com/raduma142/data-logger-management-system/blob/main/%D0%A1%D0%B8%D1%81%D1%82%D0%B5%D0%BC%D0%B0%20%D1%83%D0%BF%D1%80%D0%B0%D0%B2%D0%BB%D0%B5%D0%BD%D0%B8%D1%8F%20%D1%80%D0%B5%D0%B3%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%B0%D0%BC%D0%B8%20%D0%B4%D0%B0%D0%BD%D0%BD%D1%8B%D1%85%20-%20%D0%9F%D1%80%D0%B5%D0%B7%D0%B5%D0%BD%D1%82%D0%B0%D1%86%D0%B8%D1%8F.pdf)*
...
**Локальный сервер просмотра трансляции с веб-камеры на основе одноплатного компьютера Raspberry Pi**\
  2023
  > ОС: Linux, Windows\
  > Стек: Python 3 (библиотеки http.server, cv2), HTML, CSS, JavaScript\
  > Описание проекта:\
...
**Манимулятор курсором мыши на основе джойстика с использованием микроконтроллера Arduino**\
  2023
  > ОС: Windows\
  > Стек: Python 3 (библиотеки serial, pyautogui, threading), Arduino C\
  > Описание проекта:\
...
**Генератор изображений**\
  ...
  > ОС: Windows, Linux\
  > Стек: Python 3 (библиотеки Pillow/PIL, tkinter, os, random)\
  > Описание проекта:\
...
* **[Puzzle Combiner](https://github.com/raduma142/puzzle-combiner)**\
**Комбинатор пазлов с возможностью их сканирования**
  > ОС: Windows\
  > Стек: Delphi 7, Python 2 (библиотеки twain, Pillow/PIL, Tkinter)\
  > Описание проекта:\
  > *Пазлокомбинатор позволяет отсканировать пазлы на принтере и подобрать пары подходящих пазл.*
