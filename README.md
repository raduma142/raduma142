...
* **[Camera Web Viewer](https://github.com/raduma142/camera-web-viewer) - Локальный сервер просмотра трансляции с веб-камеры на основе одноплатного компьютера Raspberry Pi:**\
ОС: Linux\
